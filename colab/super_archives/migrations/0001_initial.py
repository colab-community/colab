    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.ForeignKey(related_name='blocks', to='super_archives.Message')),
            ],
            options={
                'ordering': ('order',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spam', models.BooleanField(default=False)),
                ('latest_message', models.OneToOneField(related_name='+', null=True, to='super_archives.Message', help_text='Latest message posted', verbose_name='Latest message')),
